...
# === USER SETTINGS ===
SETTINGS = {
    "hostname": "pz-testing.local",
    "username": "pi",
    "password": "dpea7266!",
    "remote_folder": "/home/pi/Documents/hapaz_test",
    "file_types": [],
...
def upload_files(sftp, local_files, remote_folder):
    try:
        ...
        mkdir_recursive(sftp, remote_folder)
        sftp.chdir(remote_folder)
    ...
    for local_path in local_files:
        ...
        # Create remote path with forward slashes (SFTP standard)
